    ...
    <main className="main-content">
      <section>
        ...
        <p>
          ...
          developer with a keen interest in creating impactful digital
          solutions. Currently, I am enhancing my skills through the UCI
          Bootcamp, where I’m diving deep into modern web development
        ...
        <h3>What I Do</h3>
        <p>
          In my projects, I aim to combine technical proficiency with
          creativity, ensuring each application is not only functional but also
          engaging and easy to navigate. My work spans from front-end design to
          back-end architecture, showcasing a full spectrum of skills from
          crafting intuitive user interfaces to managing robust server-side
          operations.
        </p>
        ...
        <p>
          ...
          solving problems and making technology work for people. I believe in
          the power of technology to improve lives and connect communities, and
          I strive to contribute to this goal with every project I undertake.
        </p>
